      ...
      <header className="sticky top-0 z-10 bg-black/80 backdrop-blur-md border-b border-white/10 px-6 py-4">
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-black tracking-tighter text-white uppercase italic">EnvisionPaths</h1>
              <p className="text-[10px] font-bold text-red-500 uppercase tracking-[0.2em]">Elite Career Coaching</p>
            </div>
          </div>
