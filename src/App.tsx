...
Generated by EnvisionPaths Career Intelligence`;
  ...
  const setup2FA = async () => {
    try {
      const res = await fetch('/api/admin/setup-2fa', { method: 'POST' });
      const data = await res.json();
      if (res.ok) {
          ...
          {step === 'auth' ? (
            ...
            >
              <div className="max-w-4xl w-full grid lg:grid-cols-2 gap-12 items-center">
                ...
                {authMode === 'login' && (email.trim() === 'harrisonw707@gmail.com') && (
                  <motion.div 
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    className="mb-6 p-4 bg-blue-500/10 border border-blue-500/20 rounded-xl text-blue-400 text-[10px] font-bold uppercase tracking-widest text-center"
                  >
                ...
                {authMode === 'login' && (email.trim() === 'harrisonw707@gmail.com') && (
                  ...
                  >
                    <button 
                      ...
                      className="w-full p-5 bg-emerald-600 hover:bg-emerald-700 text-white font-black uppercase tracking-[0.2em] rounded-xl transition-all shadow-lg shadow-emerald-900/20 flex items-center justify-center gap-2 border border-white/20 group"
                    >
