  ...
  const selectPlan = async (plan: 'beginner' | 'pro') => {
    ...
    try {
      ...
      const paymentLinks: Record<string, string> = {
        beginner: 'https://buy.stripe.com/test_beginner_link',
        ...
        <div className="fixed inset-0 bg-black/90 backdrop-blur-xl flex flex-col items-center justify-center z-[100] animate-in fade-in duration-500">
          ...
          {showSkipLoading && (
            <motion.button
              ...
              className="mt-12 px-6 py-2 border border-white/10 rounded-full text-[10px] font-bold uppercase tracking-widest text-zinc-500 hover:text-white hover:border-white/20 transition-all"
            >
              Skip Loading
            </motion.button>
          )}
