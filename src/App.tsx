  ...
  const TesterGuide = () => (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="mt-6 pt-6 border-t border-theme flex flex-wrap gap-4">
          <button 
            onClick={() => setStep('pricing')}
            className="px-4 py-2 bg-theme-surface-hover hover:opacity-80 border border-theme rounded-xl text-[10px] font-black uppercase tracking-widest transition-all text-theme-primary"
          >
            Test Pricing Flow
          </button>
          <button 
          ...
          <button 
            ...
            className="px-4 py-2 bg-red-600 hover:bg-red-700 border border-red-500 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all text-white"
          >
                          ...
                          <div key={reminder.id} className={`flex items-center justify-between p-4 bg-theme-input border rounded-2xl transition-all ${reminder.completed ? 'border-emerald-500/20 opacity-50' : 'border-theme hover:border-red-500/30'}`}>
                            <div className="flex items-center gap-4">
                              ...
                              <div className="min-w-0">
                                <p className={`text-[10px] font-black uppercase tracking-widest truncate ${reminder.completed ? 'line-through text-theme-secondary' : 'text-theme-primary'}`}>{reminder.title}</p>
                                <p className="text-[8px] text-theme-secondary uppercase font-black tracking-widest mt-1 truncate">
      ...
      >
        <div className="mb-6 p-4 bg-blue-500/10 border border-blue-500/20 rounded-xl">
          ...
          <p className="text-xs text-theme-secondary mt-1">
            Set a title, date, and time for your upcoming interview practice. We'll add this to your dashboard reminders so you stay on track with your preparation goals.
          </p>
        </div>
        <form onSubmit={addReminder} className="space-y-6">
          <div className="space-y-2">
            <label className="text-[10px] font-black uppercase tracking-wider text-theme-secondary">Title</label>
            <input 
              type="text" 
              required
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-2">
              <label className="text-[10px] font-black uppercase tracking-wider text-theme-secondary">Date</label>
              <input 
                type="date" 
                required
                value={reminderDate}
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-black uppercase tracking-wider text-theme-secondary">Time</label>
              <input 
                type="time" 
                required
                value={reminderTime}
          ...
          <div className="space-y-2">
            <label className="text-[10px] font-black uppercase tracking-wider text-theme-secondary">Description (Optional)</label>
            <textarea 
