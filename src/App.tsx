                    ...
                    <form onSubmit={(e) => handleSendMessage(e)} className="relative flex gap-4 items-center">
                      ...
                      <div className="relative flex-1">
                        ...
                        <textarea
                          ...
                          className="w-full pl-8 pr-20 py-5 bg-theme-surface border border-theme rounded-2xl shadow-2xl focus:border-red-600 focus:ring-1 focus:ring-red-600 outline-none transition-all text-lg text-theme-primary resize-none overflow-y-auto min-h-[80px] max-h-[200px] leading-relaxed"
                          style={{ height: 'auto' }}
                        />
                        {showRetry && (
                          <button 
