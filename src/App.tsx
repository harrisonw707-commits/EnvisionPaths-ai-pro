...
import { getCoachResponse, getInitialQuestion, getPerformanceReport } from './services/coachService';
...
Generated by EnvisionPaths Career Intelligence`;
  ...
  const generateSummary = async () => {
    try {
      ...
      const response = await getPerformanceReport(conversation, jobTitle, isFree);
  ...
  const startInterview = async () => {
    ...
    try {
      ...
      const response = await getInitialQuestion(jobTitle, industry);
      setMessages([{
        role: 'model',
        text: response.text,
        timestamp: new Date()
  ...
  const handleSendMessage = async (e: React.FormEvent, overrideInput?: string) => {
    ...
    try {
      ...
      const response = await Promise.race([
        getCoachResponse(messageText, history, { jobTitle, isFree, isPro, questionsAsked, interviewLength }),
                  ...
                  <div className="space-y-6">
                    {!isSettingUp2FA ? (
                      ...
                      <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        <div className="flex justify-center p-4 bg-theme-surface rounded-xl">
