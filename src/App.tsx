...
Generated by EnvisionPaths Career Intelligence`;
  ...
  return (
    <div className={`flex flex-col min-h-screen bg-theme-main font-sans text-theme-primary selection:bg-red-600 selection:text-white transition-colors duration-300 ${theme === 'light' ? 'theme-light' : ''}`}>
                ...
                <>
                  <div className="hidden md:flex flex-col items-end mr-4">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] font-black text-theme-primary">{questionsAnswered}/{interviewLength}</span>
                    </div>
                  </div>
              ...
              <div className="flex-1 overflow-hidden flex flex-col gap-2">
                ...
                {isTyping && (
                  ...
                  <div className="mt-auto pt-4 border-t border-theme">
                    ...
                    <form onSubmit={(e) => handleSendMessage(e)} className="flex gap-4 items-end">
                      <div className="flex flex-col gap-2">
                        <span className="text-[10px] font-bold uppercase tracking-widest text-theme-secondary ml-1">Mode</span>
                        <Tooltip content={`Switch to ${interactionMode === 'text' ? 'Voice' : 'Text'} Input`}>
                          <button
                            ...
                            className={`w-14 h-14 rounded-2xl flex items-center justify-center transition-all border flex-shrink-0 ${
                              interactionMode === 'voice' 
                                ? 'bg-red-600 border-red-500 text-white shadow-lg shadow-red-900/20' 
                                : 'bg-theme-surface border-theme text-theme-secondary hover:border-red-500/50 hover:text-red-500'
                            }`}
                          >
                            {interactionMode === 'text' ? <Mic size={20} /> : <Keyboard size={20} />}
                          </button>
                        </Tooltip>
                      </div>

                      <div className="relative flex-1 space-y-2">
                        <label htmlFor="chatInput" className="text-[10px] font-bold uppercase tracking-widest text-theme-secondary ml-1">Your Response</label>
                        <div className="relative">
                          <MessageSquare className="absolute left-4 top-1/2 -translate-y-1/2 text-theme-secondary" size={18} />
                          <input 
                            id="chatInput"
                            name="chatInput"
                            type="text"
                            ...
                            className="w-full pl-12 pr-14 py-4 bg-theme-input border border-theme rounded-2xl focus:border-red-500 focus:ring-1 focus:ring-red-500 outline-none transition-all text-sm text-theme-primary placeholder:text-theme-secondary/50"
                          />
                          ...
                          <button 
                            ...
                            className="absolute right-2 top-1/2 -translate-y-1/2 w-10 h-10 bg-red-600 text-white rounded-xl flex items-center justify-center hover:bg-red-700 disabled:opacity-30 transition-all shadow-md"
                          >
                      ...
                      {interactionMode === 'voice' && (
                        <div className="flex flex-col gap-2">
                          <span className="text-[10px] font-bold uppercase tracking-widest text-theme-secondary ml-1">Mic</span>
                          <button
                            type="button"
                          ...
                          >
                            <Mic size={20} className={isListening ? 'text-white' : 'text-theme-secondary'} />
                          </button>
                        </div>
                      )}
                    </form>
