              ...
              <div className="flex-1 overflow-hidden flex flex-col gap-8">
                ...
                {isTyping && (
                  ...
                  <div className="mt-auto pt-6 border-t border-theme">
                    ...
                    <form onSubmit={(e) => handleSendMessage(e)} className="relative flex gap-4 items-center">
                      ...
                      <div className="relative flex-1">
                        ...
                        <input 
                          ...
                          className="w-full pl-8 pr-20 py-8 bg-theme-surface border border-theme rounded-2xl shadow-2xl focus:border-red-600 focus:ring-1 focus:ring-red-600 outline-none transition-all text-xl text-theme-primary"
                        />
                        {showRetry && (
                          <button 
                            type="button"
